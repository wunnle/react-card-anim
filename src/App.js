  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <a className="goHome" onClick={this.handleOnClickHome}>Go to home</a>
        </header>
        {data.map((o, i) => <Article articleStyle={this.state.style1} handleOnClick={this.handleOnClickArticle} img={o.img} name={o.name} text={o.text} key={i} />)}
      </div>
    );
  }
}
...
class Article extends Component {
  ...
  render() {
    return (
      <div>
        <article style={this.state.style} onClick={this.openAnimation.bind(this)}>
        {this.state.fullScreen && <div onClick={this.closeAnimation.bind(this)} className="article__close">X</div>}
        <figure>
          <img src={this.props.img} />
        </figure>
          <h1>{this.props.name}</h1>
          {this.state.fullScreen && <div className="article__inner">{this.props.text}</div>}
        </article>
